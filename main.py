...
tambahan = Checkbutton(top, text="POP Filter", variable=var1, onvalue = "POP Filter", offvalue="")
tambahan.deselect()
tambahan.grid(column=1, row=4)

var2 = StringVar()

tambahan = Checkbutton(top, text="Stand Mic", variable=var2, onvalue = "Stand Mic", offvalue="")
tambahan.deselect()
tambahan.grid(column=2, row=4)

var3 = StringVar()

tambahan = Checkbutton(top, text="Busa Angin", variable=var3, onvalue = "Busa Angin", offvalue="")
tambahan.deselect()
tambahan.grid(column=3, row=4)

myButton = Button(top, text="Open Photo File", fg="Black", bg="#FFFFFF")
myButton.grid(row=2, column=4)

myButton = Button(top, text="Submit", fg="Black", bg="#FFFFFF")
myButton.grid(row=3, column=4)

myButton = Button(top, text="See All Submissons", fg="Black", bg="#FFFFFF")
myButton.grid(row=5, column=1)

myButton = Button(top, text="Clear Submissons", fg="Black", bg="#FFFFFF")
myButton.grid(row=6, column=1)

myButton = Button(top, text="Exit", fg="Black", bg="#FFFFFF")
